...
3.1 Для того, чтобы создать сводную таблицу, выделите столбцы, по которым будет создаваться сводная таблица. Обратите внимание, что они все должны иметь уникальные заголовки.
